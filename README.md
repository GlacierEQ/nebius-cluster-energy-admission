# Cluster Energy Admission

Independent GlacierEQ portfolio exhibit aligned to **Nebius** operating themes.

> **Not affiliated.** This repository is not affiliated with, endorsed by, employed by, or deployed at Nebius.
...
**Cluster Energy Admission** — Admit jobs only under measured energy/power envelopes with explicit reject receipts.
...
Lead with a small, inspectable Cluster Energy Admission exhibit and explicit non-affiliation boundary.
...
| Surface | Path |
|---------|------|
| Mechanism stub | `src/cluster_energy_admission.py` |
...
- No Nebius employment, endorsement, proprietary data, or production use
